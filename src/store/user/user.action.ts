...
export type TCheckUserSession =
  TAction<USER_ACTION_TYPES.CHECK_USER_SESSION>;
...
export type TGoogleSignInStart =
  TAction<USER_ACTION_TYPES.GOOGLE_SIGN_IN_START>;

export type TEmailSignInStart =
  TActionWithPayload<
...
export type TSignInFaild = TActionWithPayload<
...
export type TSignOutStart =
  TAction<USER_ACTION_TYPES.SIGN_OUT_START>;

export type TSignOutSuccess =
  TAction<USER_ACTION_TYPES.SIGN_OUT_SUCCESS>;
...
// // Type of actions the user reducer can accept
